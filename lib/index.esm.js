...
var Button = function (_a) {
    ...
    return (React__default.createElement("button", { type: "button", className: ["storybook-button", "storybook-button--" + size, mode].join(" "), style: backgroundColor ? { backgroundColor: backgroundColor } : {}, onClick: onClick }, label));
};
...
var HttpService = /** @class */ (function () {
    function HttpService() {
        var _this = this;
        this.apiCall = function (url, request, extraHeaders) {
            return new Promise(function (resolve, reject) {
                ...
                var takeCallback = function () {
                    http.post(url, request, {
                        headers: __assign$1(__assign$1({}, headers), extraHeaders),
                        ...
                        count++;
                        _this.handleError(httpError).then(function (handleError) {
                            if (handleError === 'unAuthorizedError') {
                                _this.checkToken().then(function () {
                                    if (count >= 3) {
                                        reject(httpError);
                                    }
                                    else {
        ...
        this.getApiCall = function (url, request, extraHeaders) {
            return new Promise(function (resolve, reject) {
                var count = 0;
                var headers = {
                    Authorization: "Bearer " + _this.getAccessToken(),
                ...
                var takeCallback = function () {
                    http.get(url, {
                        headers: __assign$1(__assign$1(__assign$1({}, headers), extraHeaders), (request ? { params: request } : {}))
                    }).then(function (response) {
                        resolve(response);
                    }).catch(function (httpError) {
                        console.log('service');
        ...
        this.multipartApiCall = function (endPoint, formData, methodType, backendUrl, uploadProgressEvent, responseType, authKey) {
            return new Promise(function (resolve2, reject2) {
                ...
                axios.post(URL + endPoint, formData, __assign$1(__assign$1({}, config), { headers: headers }))
    ...
    HttpService.prototype.refreshToken = function () {
        ...
        return this.apiCall('/oauth/token', this.formatData(request), {
            'Content-Type': 'application/x-www-form-urlencoded',
    ...
    HttpService.prototype.multipart = function (endPoint, formData, methodType, backendUrl, responseType, authKey, uploadProgressEvent) {
        var _this = this;
        if (methodType === void 0) { methodType = HttpMethodTypes.GET; }
        if (responseType === void 0) { responseType = HttpResponseTypes.blob; }
        ...
        return new Promise(function (resolve, reject) {
            var count = 0;
            var takeCallback = function () {
                _this.multipartApiCall(endPoint, formData, methodType, backendUrl, uploadProgressEvent, responseType, authKey)
...
})(HttpMethodTypes || (HttpMethodTypes = {}));
...
var HttpContext = React.createContext(httpService);

export { Button, HttpContext, HttpMethodTypes, httpService };
