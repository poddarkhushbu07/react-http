...
var Button = function (_a) {
    ...
    return (React__default.createElement("button", { type: "button", className: ["storybook-button", "storybook-button--" + size, mode, className].join(" "), style: backgroundColor ? { backgroundColor: backgroundColor } : {}, onClick: onClick }, label));
};
...
var HttpService = /** @class */ (function () {
            ...
            return new Promise(function (resolve, reject) {
                ...
                var takeCallback = function () {
                    http.get(url, {
                        ...
                        count++;
                        reject(httpError);
                        _this.processError(httpError).then(function (handleError) {
                            if (handleError === 'unAuthorizedError') {
    ...
    HttpService.prototype.get = function (endPoint, params, contentType, backendUrl, extraHeaders, responseType, withCredentials) {
        var _this = this;
        if (responseType === void 0) { responseType = HttpResponseTypes.json; }
        return new Promise(function (resolve, reject) {
            var count = 0;
...
export { Button, HttpConstants, HttpContext, HttpMethodTypes, HttpResponseTypes, URL, httpService };
