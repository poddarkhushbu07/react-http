            ...
            var takeCallback = function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, http.post(endPoint, requestBody, config)];
                        case 1:
                            response = _a.sent();
                            resolve(response);
                            return [3 /*break*/, 3];
...
React.createContext(httpService);

export { Button, HttpConstants, HttpMethodTypes, HttpResponseTypes, URL, httpService };
